...
Route::post('/approveApp/{application}',[applyEventController::class,'approve'])->name('approved');
Route::post('/rejectApp/{application}',[applyEventController::class,'reject'])->name('rejected');
